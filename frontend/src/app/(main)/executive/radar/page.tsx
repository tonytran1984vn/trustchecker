...
import MacroRadar from "@/components/executive/MacroRadar";
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    fetch("/trustchecker/api/executive/radar", {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Macro Radar</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Systemic risk scanning and global constraint awareness.</p>
        </div>
      </div>
