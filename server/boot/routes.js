...
function setupRoutes(app) {
    ...
    const API_ROUTES = [
        ...
        ['/sustainability', requireFeature('sustainability'), sustainabilityRoutes],
        ['/compliance', requireFeature('compliance'), complianceRoutes],
        ['/anomaly', requireFeature('anomaly'), anomalyRoutes],
        ['/assistant', aiChatRoutes],
        ['/branding', requireFeature('branding'), brandingRoutes],
        ['/wallet', requireFeature('wallet'), walletPaymentRoutes],
