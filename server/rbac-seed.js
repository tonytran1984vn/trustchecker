...
const PERMISSIONS = [
    ...
    {
        resource: 'platform',
        action: 'audit_view_all',
        scope: 'global',
        level: 'platform',
        desc: 'View global audit logs',
    },
    {
        resource: 'platform',
        action: 'admin_reset',
    ...
    { resource: 'esg', action: 'export', scope: 'org', level: 'business', desc: 'Export ESG reports' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Manage ESG data (DID/VC, carbon offsets, credit pipeline)',
    },
    { resource: 'sustainability', action: 'view', scope: 'org', level: 'business', desc: 'View sustainability' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Assess product sustainability',
    },
    {
        resource: 'sustainability',
        action: 'manage',
        scope: 'org',
        level: 'business',
        desc: 'Issue green certifications',
    },
    ...
    { resource: 'billing', action: 'view', scope: 'org', level: 'business', desc: 'View billing' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Manage billing plans and invoices',
    },
    ...
    { resource: 'payment', action: 'create', scope: 'org', level: 'business', desc: 'Create payment requests' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Approve payment requests (SoD: cannot also create)',
    },
    ...
    {
        resource: 'graph_schema',
        action: 'propose',
        scope: 'org',
        level: 'business',
        desc: 'Propose graph schema change RFC',
    },
    {
        resource: 'graph_schema',
        action: 'approve',
        scope: 'org',
        level: 'business',
        desc: 'Approve graph schema change',
    },
    ...
    {
        resource: 'graph_weight',
        action: 'propose',
        scope: 'org',
        level: 'business',
        desc: 'Propose weight recalibration',
    },
    {
        resource: 'graph_weight',
        action: 'approve',
        scope: 'org',
        level: 'business',
        desc: 'Approve weight recalibration',
    },
    {
        resource: 'graph_override',
        action: 'request',
        scope: 'org',
        level: 'business',
        desc: 'Request trust graph override',
    },
    {
        resource: 'graph_override',
        action: 'approve',
        scope: 'org',
        level: 'business',
        desc: 'Approve trust graph override',
    },
    ...
    { resource: 'lineage', action: 'view', scope: 'org', level: 'business', desc: 'View decision lineage' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Replay decision for determinism check',
    },
    {
        resource: 'lineage',
        action: 'impact',
        scope: 'org',
        level: 'business',
        desc: 'Run contamination impact analysis',
    },
    ...
    {
        resource: 'model_certification',
        action: 'issue',
        scope: 'org',
        level: 'business',
        desc: 'Issue model certification',
    },
    ...
    { resource: 'emission_model', action: 'submit', scope: 'org', level: 'business', desc: 'Submit emission model' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Request carbon credit mint',
    },
    {
        resource: 'carbon_credit',
        action: 'approve_mint',
        scope: 'org',
        level: 'business',
        desc: 'Approve carbon credit mint',
    },
    {
        resource: 'carbon_credit',
        action: 'anchor',
        scope: 'org',
        level: 'business',
        desc: 'Anchor carbon credit on chain',
    },
    {
        resource: 'carbon_credit',
        action: 'verify',
        scope: 'org',
        level: 'business',
        desc: 'Verify carbon credit chain',
    },
    // Blockchain Governance
    {
        resource: 'blockchain_anchor',
        action: 'create',
        scope: 'org',
        level: 'business',
        desc: 'Create blockchain anchor',
    },
    {
        resource: 'blockchain_anchor',
        action: 'verify',
    ...
    {
        resource: 'regulatory_export',
        action: 'approve',
        scope: 'org',
        level: 'business',
        desc: 'Approve regulatory export',
    },
    ...
    },
    {
        ...
        scope: 'global',
        level: 'platform',
        desc: 'Review session recordings',
    },
    {
        resource: 'api_access',
        action: 'approve',
        scope: 'global',
        level: 'platform',
        desc: 'Approve API access requests',
    },
    ...
    // ── Data Governance Permissions (L5) ──────────────────────────────────────
    {
        ...
        scope: 'global',
        level: 'platform',
        desc: 'Define data classification',
    },
    {
        resource: 'data_classification',
        action: 'approve',
        scope: 'global',
        level: 'platform',
        desc: 'Approve data classification',
    },
    {
        ...
        scope: 'global',
        level: 'platform',
        desc: 'Approve data retention policy',
    },
    {
        resource: 'gdpr_masking',
        action: 'configure',
        scope: 'global',
        level: 'platform',
        desc: 'Configure GDPR masking rules',
    },
    {
        ...
        scope: 'global',
        level: 'platform',
        desc: 'Approve cross border data transfer',
    },
    {
        resource: 'lineage_export',
        action: 'approve',
        scope: 'global',
        level: 'platform',
        desc: 'Approve lineage export',
    },
    {
        resource: 'lineage_export',
        action: 'execute',
    ...
    {
        resource: 'blockchain_integrity',
        action: 'view',
        scope: 'global',
        level: 'platform',
        desc: 'View blockchain integrity',
    },
    {
        resource: 'lineage_registry',
        action: 'integrity_check',
        scope: 'global',
        level: 'platform',
        desc: 'Lineage registry integrity check',
    },

    // ── CIE v2.0 — Carbon Integrity Engine Permissions ───────────────────────
    // Platform-level CIE (MGB, Global Risk)
    {
        resource: 'cie_methodology',
        action: 'propose',
        scope: 'global',
        level: 'platform',
        desc: 'Propose methodology version change',
    },
    {
        resource: 'cie_methodology',
        action: 'vote',
        scope: 'global',
        level: 'platform',
        desc: 'Vote on methodology change',
    },
    {
        resource: 'cie_methodology',
        action: 'freeze',
        scope: 'global',
        level: 'platform',
        desc: 'Freeze emission factor set',
    },
    {
        resource: 'cie_methodology',
        action: 'publish',
        scope: 'global',
        level: 'platform',
        desc: 'Publish methodology change bulletin',
    },
    {
        resource: 'cie_risk_config',
        action: 'set_weights',
        scope: 'global',
        level: 'platform',
        desc: 'Configure global risk scoring weights',
    },
    {
        resource: 'cie_risk_config',
        ...
        scope: 'global',
        level: 'platform',
        desc: 'Set global anomaly threshold',
    },
    {
        resource: 'cie_ivu_registry',
        action: 'manage',
        scope: 'global',
        level: 'platform',
        desc: 'Manage IVU validator registry',
    },
    {
        resource: 'cie_ivu_registry',
        action: 'verify_qual',
        scope: 'global',
        level: 'platform',
        desc: 'Verify IVU qualification',
    },
    // Org-level CIE (SoD-enforced)
    {
        resource: 'cie_passport',
        action: 'submit',
        scope: 'org',
        level: 'business',
        desc: 'Submit emission data and create CIP draft',
    },
    {
        resource: 'cie_passport',
        action: 'calculate',
        scope: 'org',
        level: 'business',
        desc: 'Execute deterministic emission calculation (system)',
    },
    ...
    { resource: 'cie_passport', action: 'validate', scope: 'org', level: 'business', desc: 'Validate CIP (IVU only)' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Approve CIP for sealing (Compliance only)',
    },
    {
        resource: 'cie_passport',
        action: 'seal',
        scope: 'org',
        level: 'business',
        desc: 'Seal CIP (system auto after all gates pass)',
    },
    { resource: 'cie_passport', action: 'view', scope: 'org', level: 'business', desc: 'View CIP passport' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Anchor CIP hash to blockchain',
    },
    ...
    { resource: 'cie_replay', action: 'view', scope: 'org', level: 'business', desc: 'View-only replay (Level 1)' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'What-if simulation replay (Level 2)',
    },
    {
        resource: 'cie_replay',
        action: 'forensic',
        scope: 'org',
        level: 'business',
        desc: 'Full lineage forensic replay (Level 3)',
    },
    ...
    // CIE v2.1 — Enterprise Ready permissions
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Validate data completeness (Data Steward)',
    },
    {
        resource: 'cie_data',
        ...
        scope: 'org',
        level: 'business',
        desc: 'Reject incomplete submission (Data Steward)',
    },
    {
        resource: 'cie_data',
        ...
        scope: 'org',
        level: 'business',
        desc: 'Manage metadata quality (Data Steward)',
    },
    { resource: 'cie_audit', action: 'view_trail', scope: 'org', level: 'business', desc: 'View full CIE audit trail' },
    {
        resource: 'cie_audit',
        action: 'view_sod_violations',
        scope: 'org',
        level: 'business',
        desc: 'View SoD violation attempts',
    },
    {
        resource: 'cie_audit',
        ...
        scope: 'org',
        level: 'business',
        desc: 'View CIE change history',
    },
    {
        resource: 'cie_liability',
        action: 'view',
        scope: 'org',
        level: 'business',
        desc: 'View liability mapping and responsibility allocation',
    },
    {
        resource: 'cie_escalation',
        action: 'view_history',
        scope: 'org',
        level: 'business',
        desc: 'View escalation history',
    },
    // CIE v2.5 — Supply Chain + Audit Ready permissions
    {
        resource: 'cie_supplier',
        action: 'submit_emission',
        scope: 'org',
        level: 'business',
        desc: 'Submit supplier emission declaration',
    },
    {
        resource: 'cie_supplier',
        action: 'upload_docs',
        scope: 'org',
        level: 'business',
        desc: 'Upload supplier supporting documents',
    },
    {
        resource: 'cie_esg',
        ...
        scope: 'org',
        level: 'business',
        desc: 'Generate consolidated ESG report',
    },
    {
        resource: 'cie_esg',
        action: 'portfolio_carbon',
        scope: 'org',
        level: 'business',
        desc: 'Extract portfolio carbon report',
    },
    {
        resource: 'cie_esg',
        action: 'investor_disclosure',
        scope: 'org',
        level: 'business',
        desc: 'Prepare investor disclosure',
    },
    {
        resource: 'cie_external_audit',
        action: 'read_snapshot',
        scope: 'org',
        level: 'business',
        desc: 'Read-only snapshot capsule (external auditor)',
    },
    {
        resource: 'cie_external_audit',
        ...
        scope: 'org',
        level: 'business',
        desc: 'Limited sandbox replay (external auditor)',
    },
    // CIE v3.0 — Institutional Grade permissions
    {
        resource: 'cie_finance',
        action: 'view_score',
        scope: 'org',
        level: 'business',
        desc: 'View Carbon Integrity Score (financial institution)',
    },
    {
        resource: 'cie_finance',
        action: 'view_selected_cip',
        scope: 'org',
        level: 'business',
        desc: 'View selected CIP (no supplier confidential data)',
    },
    {
        resource: 'cie_public',
        action: 'verify_qr',
        scope: 'platform',
        level: 'business',
        desc: 'Public QR verification (unauthenticated)',
    },
    {
        resource: 'cie_public',
        action: 'check_hash',
        scope: 'platform',
        level: 'business',
        desc: 'Public hash check (unauthenticated)',
    },
    {
        resource: 'cie_change_mgmt',
        action: 'approve_upgrade',
        scope: 'platform',
        level: 'platform',
        desc: 'Approve system upgrade request',
    },
    {
        resource: 'cie_change_mgmt',
    ...
    },
    {
        ...
        scope: 'platform',
        level: 'platform',
        desc: 'Freeze deployment window',
    },
    {
        resource: 'cie_incident',
        action: 'activate_protocol',
        scope: 'platform',
        level: 'platform',
        desc: 'Activate incident protocol',
    },
    {
        resource: 'cie_incident',
        action: 'freeze_anchor',
        scope: 'platform',
        level: 'platform',
        desc: 'Freeze blockchain anchor process',
    },
    {
        resource: 'cie_incident',
        action: 'trigger_forensic',
        scope: 'platform',
        level: 'platform',
        desc: 'Trigger forensic logging',
    },
    // CIE v3.0 — Disclosure Officer permissions
    {
        resource: 'cie_disclosure',
        action: 'sign_off',
        scope: 'org',
        level: 'business',
        desc: 'Final sign-off public carbon statement',
    },
    {
        resource: 'cie_disclosure',
        action: 'link_annual_report',
        scope: 'org',
        level: 'business',
        desc: 'Link CIP to annual report',
    },
    {
        resource: 'cie_disclosure',
        action: 'certify_csrd',
        scope: 'org',
        level: 'business',
        desc: 'Certify CSRD/ESRS alignment',
    },
    {
        resource: 'cie_disclosure',
        action: 'view_liability',
        scope: 'org',
        level: 'business',
        desc: 'View liability mapping for disclosure',
    },
    ...
    { resource: 'change', action: 'create', scope: 'global', level: 'platform', desc: 'Create change request' },
    {
        ...
        scope: 'global',
        level: 'platform',
        desc: 'Approve change request (SoD: cannot also create)',
    },
    // Compliance enrichment
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Investigate compliance issue',
    },
    {
        resource: 'compliance',
        action: 'escalate',
        scope: 'org',
        level: 'business',
        desc: 'Escalate compliance violation',
    },
    ...
    { resource: 'org', action: 'transfer_ownership', scope: 'org', level: 'business', desc: 'Transfer org ownership' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Control org billing settings',
    },
    ...
    { resource: 'user', action: 'suspend', scope: 'org', level: 'business', desc: 'Suspend user account' },
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Conduct quarterly access review',
    },
    ...
    // Risk Officer enrichment
    {
        ...
        scope: 'org',
        level: 'business',
        desc: 'Escalate fraud case to committee',
    },
...
const SYSTEM_ROLES = [
    // ── L5 — Platform Infrastructure (4 roles) ──────────────────────
    {
        ...
        is_system: 1,
        org_id: null,
        desc: 'L5 Platform — platform lifecycle, observability, NOT business authority',
        mfa_policy: 'required',
    },
    {
        name: 'platform_security_admin',
        display: 'Platform Security Admin',
        type: 'system',
        is_system: 1,
        org_id: null,
        desc: 'L5 Platform — Security ops, incident response, change management. Merged: SOC + IR + ITIL Change. SoD: change:create ≠ change:approve',
        mfa_policy: 'required',
    },
    {
        name: 'data_gov_officer',
        display: 'Data Governance Officer',
        type: 'system',
        is_system: 1,
        org_id: null,
        desc: 'L5 Platform — classification, retention, GDPR masking, cross-border transfer, data access approval',
        mfa_policy: 'required',
    },
    {
        name: 'svc_emission_engine',
        display: 'Emission Engine [SYSTEM]',
        type: 'system',
        is_system: 1,
        org_id: null,
        desc: 'L5 SYSTEM — Machine identity. Deterministic calculation. Locked formula. No manual override.',
        mfa_policy: 'none',
    },
    // ── L4 — Federation & Independent Validation ──────────────────
    {
        name: 'ivu_registry_admin',
        display: 'IVU Registry Admin',
        type: 'system',
        is_system: 1,
        org_id: null,
        desc: 'L4 Federation — validator registry. Cannot validate CIP.',
        mfa_policy: 'required',
    },
    {
        name: 'blockchain_operator',
        display: 'Blockchain Anchor Authority',
        type: 'system',
        is_system: 1,
        org_id: null,
        desc: 'L4 Federation — anchor hashes. Federated for trust. Cannot create/modify CIP.',
        mfa_policy: 'required',
    },
    // ── L3 — Org (template) ────────────────────────────────────
    {
        name: 'org_owner',
        display: 'Organization Owner',
        type: 'system',
        is_system: 1,
        org_id: '__TEMPLATE__',
        desc: 'L3 Org — Legal representative. Appoints/removes Company Admin. Owns org billing and transfer.',
        mfa_policy: 'required',
    },
    {
        name: 'company_admin',
        ...
        is_system: 1,
        org_id: '__TEMPLATE__',
        desc: 'L3 Org — Operational IAM controller. Manages roles/users/config within boundary. CANNOT grant governance permissions. High-risk role assigns require dual-approval.',
        mfa_policy: 'required',
    },
];
...
const DEFAULT_BUSINESS_ROLES = [
    ...
    },
    {
        ...
        permissions: [
            ...
            'blockchain:view',
            'blockchain:create',
            'blockchain_anchor:create',
            'blockchain_anchor:verify',
            'graph_snapshot:view',
            'nft:view',
    ...
    // NOTE: financial_viewer removed — merged into enriched Viewer role
    {
        ...
        permissions: ['dashboard:view', 'cie_public:verify_qr', 'cie_public:check_hash', 'cie_passport:view'],
    },
...
const TEST_USERS = [
    // L3 Org roles
    {
        email: 'admin@demo.trustchecker.io',
        role: 'admin',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'company_admin',
        must_change_password: 1,
    },
    {
        email: 'ceo@demo.trustchecker.io',
        role: 'executive',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
    ...
    {
        email: 'ops@demo.trustchecker.io',
        role: 'ops_manager',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'ops_manager',
        must_change_password: 1,
    },
    {
        email: 'risk@demo.trustchecker.io',
        role: 'risk_officer',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'risk_officer',
        must_change_password: 1,
    },
    {
        email: 'compliance@demo.trustchecker.io',
        role: 'compliance_officer',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'compliance_officer',
        must_change_password: 1,
    },
    {
        email: 'dev@demo.trustchecker.io',
        role: 'developer',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
    ...
    {
        email: 'carbon@demo.trustchecker.io',
        role: 'carbon_officer',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'carbon_officer',
        must_change_password: 1,
    },
    {
        email: 'scm@demo.trustchecker.io',
        role: 'scm_analyst',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'scm_analyst',
        must_change_password: 1,
    },
    {
        email: 'finance@demo.trustchecker.io',
        role: 'finance_controller',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'finance_controller',
        must_change_password: 1,
    },
    {
        email: 'disclosure@demo.trustchecker.io',
        role: 'disclosure_officer',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'disclosure_officer',
        must_change_password: 1,
    },
    // L4 Governance roles
    {
        email: 'sga@demo.trustchecker.io',
        role: 'schema_governance_admin',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'schema_governance_admin',
        must_change_password: 1,
    },
    {
        email: 'ivu@demo.trustchecker.io',
        role: 'ivu_validator',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'ivu_validator',
        must_change_password: 1,
    },
    // L1 Technical roles
    {
        email: 'viewer@demo.trustchecker.io',
        role: 'viewer',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
    ...
    {
        email: 'auditor@demo.trustchecker.io',
        role: 'auditor',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
    ...
    {
        email: 'extauditor@demo.trustchecker.io',
        role: 'external_auditor',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'external_auditor',
        must_change_password: 1,
    },
    {
        email: 'legal@demo.trustchecker.io',
        role: 'legal_counsel',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'legal_counsel',
        must_change_password: 1,
    },
    {
        email: 'reviewer@demo.trustchecker.io',
        role: 'internal_reviewer',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'internal_reviewer',
        must_change_password: 1,
    },
    {
        email: 'datasteward@demo.trustchecker.io',
        role: 'data_steward',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'data_steward',
        must_change_password: 1,
    },
    {
        email: 'supplier@demo.trustchecker.io',
        role: 'supplier_contributor',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'supplier_contributor',
        must_change_password: 1,
    },
    {
        email: 'publicverify@demo.trustchecker.io',
        role: 'public_verifier',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'public_verifier',
        must_change_password: 1,
    },
    {
        email: 'securityoff@demo.trustchecker.io',
        role: 'security_officer',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
        rbac_role: 'security_officer',
        must_change_password: 1,
    },
    {
        email: 'operator@demo.trustchecker.io',
        role: 'operator',
        user_type: 'org',
        password: '123qaz12',
        company: 'TrustChecker Demo',
    ...
    // L5 Platform roles
    {
        email: 'security@trustchecker.io',
        role: 'platform_security_admin',
        user_type: 'platform',
        password: '123qaz12',
        company: 'TrustChecker',
        rbac_role: 'platform_security_admin',
        must_change_password: 1,
    },
    {
        email: 'datagov@trustchecker.io',
        role: 'data_gov_officer',
        user_type: 'platform',
        password: '123qaz12',
        company: 'TrustChecker',
        rbac_role: 'data_gov_officer',
        must_change_password: 1,
    },
    {
        email: 'ivuadmin@trustchecker.io',
        role: 'ivu_registry_admin',
        user_type: 'platform',
        password: '123qaz12',
        company: 'TrustChecker',
        rbac_role: 'ivu_registry_admin',
        must_change_password: 1,
    },
    // L4 Federation roles
    {
        email: 'blockchain@demo.trustchecker.io',
        role: 'blockchain_operator',
        user_type: 'platform',
        password: '123qaz12',
        company: 'TrustChecker',
        rbac_role: 'blockchain_operator',
        must_change_password: 1,
    },
];
...
async function seed() {
    ...
    try {
        await db.run('CREATE INDEX IF NOT EXISTS idx_audit_log_actor ON audit_log(actor_email)');
    } catch (_) {}
    try {
        await db.run('CREATE INDEX IF NOT EXISTS idx_audit_log_org ON audit_log(org_id)');
    } catch (_) {}
    ...
    console.log(
        `  ✓ ${PERMISSIONS.length} permissions (platform: ${levels.platform}, org: ${levels.org}, business: ${levels.business})\n`
    );
    ...
    const PSA_PERMS = [
        'key:rotate',
        'privileged_access:monitor',
        'session_recording:review',
        'api_access:approve',
        'incident:declare',
        'incident:resolve',
        ...
        'cie_change_mgmt:approve_upgrade',
        'cie_change_mgmt:track_request',
        'cie_change_mgmt:freeze_deploy',
        // Merged from incident_response_lead
        'cie_incident:activate_protocol',
        'cie_incident:freeze_anchor',
        'cie_incident:trigger_forensic',
    ...
    const DATA_GOV_PERMS = [
        'data_classification:define',
        'data_classification:approve',
        'retention_policy:approve',
        'gdpr_masking:configure',
        'cross_border_transfer:approve',
        'lineage_export:approve',
        'platform_metrics:view',
    ];
    let dgCount = 0;
    ...
    for (const u of TEST_USERS) {
        ...
        if (existing) {
            userId = existing.id;
            await db.run(
                'UPDATE users SET role = ?, user_type = ?, org_id = ?, email = ?, must_change_password = ? WHERE id = ?',
        ...
        if (u.user_type === 'org') {
            ...
            const m = await db.get('SELECT id FROM memberships WHERE user_id = ? AND org_id = ?', [
                userId,
                DEFAULT_ORG.id,
            ]);
    ...
    if (adminUser) {
        await db.run(
            "UPDATE users SET user_type = 'platform', email = COALESCE(NULLIF(email, ''), 'admin@trustchecker.io') WHERE id = ?",
            [adminUser.id]
        );
