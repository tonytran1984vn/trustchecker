...
const { authMiddleware, requireRole, requirePermission, requireConstitutional, requirePlatformAdmin, requireOrgAdmin, requireOrgAdmin, JWT_SECRET, ROLE_HIERARCHY } = require('./auth/core');
...
module.exports = { router, authMiddleware, requireRole, requirePermission, requireConstitutional, requirePlatformAdmin, requireOrgAdmin, requireOrgAdmin, JWT_SECRET, ROLE_HIERARCHY };
