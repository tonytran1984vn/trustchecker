...
const { authMiddleware, requireRole, requirePermission, requireConstitutional, requirePlatformAdmin, requireOrgAdmin, requireTenantAdmin, JWT_SECRET, ROLE_HIERARCHY } = require('./auth/core');
...
module.exports = { router, authMiddleware, requireRole, requirePermission, requireConstitutional, requirePlatformAdmin, requireOrgAdmin, requireTenantAdmin, JWT_SECRET, ROLE_HIERARCHY };
