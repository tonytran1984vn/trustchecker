...
class RateLimiter {
    ...
    middleware(options = {}) {
        ...
        return (req, res, next) => {
            ...
            if (process.env.DISABLE_RATE_LIMIT === 'true') return next(); // Only explicit opt-out, never by NODE_ENV
...
module.exports = {
    ...
    apiLimit: limiter.middleware({ windowMs: 60000, max: 200, keyGenerator: 'combined', message: 'API rate limit exceeded (200/min)' }),
