...
import { renderPage as renderDataExport, initPage as initDataExport } from './data-export.js';
...
export function renderPage() {
    return renderWorkspace({
        ...
        tabs: [
            ...
            { id: 'export', label: 'Data Export', icon: icon('scroll', 14), render: renderDataExport, init: initDataExport },
