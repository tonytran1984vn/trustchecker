    ...
    <div class="sa-page">
      <div class="sa-page-title">
        ...
        <div class="sa-title-actions">
          <button class="btn btn-outline btn-sm">📥 Export Log</button>
        </div>
      </div>

      <!-- Filters -->
      <div style="display:flex;gap:8px;margin-bottom:1.5rem;flex-wrap:wrap">
        <button class="btn btn-sm btn-primary">All Activity</button>
        <button class="btn btn-sm btn-outline">My Actions</button>
        <button class="btn btn-sm btn-outline">🚨 Critical</button>
        <button class="btn btn-sm btn-outline">📦 Batches</button>
        <button class="btn btn-sm btn-outline">🚚 Transfers</button>
        <button class="btn btn-sm btn-outline">🧾 Incidents</button>
      </div>
