    ...
    <div class="sa-page">
      <div class="sa-page-title">
        ...
        <div class="sa-title-actions">
          ...
          <button class="btn btn-ghost btn-sm" onclick="showToast('⚙ Notification preferences coming soon','info')">⚙ Preferences</button>
        </div>
      </div>

      <!-- Notification Filters -->
      <div style="display:flex;gap:8px;margin-bottom:1.5rem;flex-wrap:wrap">
        <button class="btn btn-sm btn-primary" onclick="showToast('Showing all notifications','info')">All</button>
        <button class="btn btn-sm btn-outline" onclick="showToast('Filtering: Critical only','info')">🚨 Critical</button>
        <button class="btn btn-sm btn-outline" onclick="showToast('Filtering: Warning only','info')">⚠️ Warning</button>
        <button class="btn btn-sm btn-outline" onclick="showToast('Filtering: Info only','info')">ℹ️ Info</button>
        <button class="btn btn-sm btn-outline" onclick="showToast('Filtering: Success only','info')">✅ Success</button>
      </div>
