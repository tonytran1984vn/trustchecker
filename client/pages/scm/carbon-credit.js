        ...
        <div class="sa-card" style="margin-bottom:16px">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px">
                ...
                <div style="display:flex;gap:6px">
                    ...
                    <button onclick="if(confirm('Export sealed passports to carbon registry?\\n\\nThis will submit all verified carbon passports for official registry recording.')){showToast('📤 Submitting sealed passports to carbon registry…','info')}" style="padding:6px 14px;background:#1e293b;color:#94a3b8;border:1px solid #334155;border-radius:6px;cursor:pointer;font-size:0.72rem">📤 Export to Registry</button>
                </div>
            </div>
            <table style="width:100%;border-collapse:collapse;font-size:0.78rem">
                <thead><tr style="border-bottom:2px solid #1e293b;color:#94a3b8;font-size:0.68rem;text-transform:uppercase">
