...
const MATRIX = [
    ...
    },
    {
        domain: 'PLATFORM / INFRASTRUCTURE', items: [
            ...
            { resource: 'Cross-org analytics', sa: '<span class="status-icon status-pass" aria-label="Pass"><span class="status-icon status-pass" aria-label="Pass">✓</span></span>', ca: '—', ceo: '—', ops: '—', risk: '—', comp: '—', it: '—' },
