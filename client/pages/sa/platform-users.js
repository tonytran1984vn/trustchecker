...
const PLATFORM_ROLES = [
  ...
  { id: 'global_risk_committee', label: 'Global Risk Committee', desc: 'Risk scoring weights, anomaly thresholds, overclaim alert policy', color: '#f97316', icon: '⚡' },
  { id: 'emission_engine', label: 'Emission Engine', desc: 'Deterministic calculation system — locked formula, version-based', color: '#6366f1', icon: '⚙️' },
  { id: 'change_management_officer', label: 'Change Management', desc: 'System upgrades, change requests, deployment freeze windows', color: '#14b8a6', icon: '📦' },
  { id: 'incident_response_lead', label: 'Incident Response', desc: 'Incident protocol activation, anchor freeze, forensic logging', color: '#e11d48', icon: '🚨' },
